                    ...
                    methodData.className.toClass().method {
                        ...
                        list.forEach { item ->
                            item?.let {
                                ...
                                var endTime2: Long
                                if ( bookType == 1) {                                    
                                    if ( option.lastTime1 == 0L || ((currentTime + 8 *3600000) / (24*60*60*1000) != (option.lastTime1 + 8 *3600000) / (24*60*60*1000)) ){
                                    ...
                                    if ( option.lastTime2 == 0L || ((currentTime + 8 *3600000) / (24*60*60*1000) != (option.lastTime2 + 8 *3600000) / (24*60*60*1000)) ){
                                        startTime2 = getStartOfDayTimestamp()                                        
                                    }else {
